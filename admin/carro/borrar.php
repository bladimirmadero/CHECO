...
<form action="borrar2.php" class="container" method="post">
    <div>
      <label for="idCarro">Ingrese el ID del carro a borrar:</label>
      <input type="number" name="idCarro" placeholder="Ingrese un ID">
    </div>
    
    <br>
    <div>
    <button type="submit" class="btn btn-primary">Buscar y borrar</button>
    </div>
